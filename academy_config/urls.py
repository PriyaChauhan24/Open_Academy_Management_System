"""
URL configuration for academy_config project.
...
from main_academy import views
...
urlpatterns = [
    ...
    #path('welcome/', views.welcome_survey, name='welcome_survey'),
    ...
    path('', include('main_academy.urls')),
]
